# 🔍 TECHINTEL Digest — 2026-04-22

**Repos analizados:** 87 | **Relevantes para tu stack:** 77 | **Rising Stars:** 69 | **Keyword discoveries:** 59
...
📊 **5901** stars (+4223 today) | 🔤 Python | 🏷️ core-stack, web3-defi
🔥 **RISING STAR** — 8 días trending

### [Lordog/dive-into-llms](https://github.com/Lordog/dive-into-llms)
《动手学大模型Dive into LLMs》系列编程实践教程

📊 **33.694** stars (+5167 today) | 🔤 Jupyter Notebook | 🏷️ core-stack
🔥 **RISING STAR** — 8 días trending

### [EvoMap/evolver](https://github.com/EvoMap/evolver)
The GEP-powered self-evolving engine for AI agents. Auditable evolution with Genes, Capsules, and Events. | evomap.ai

📊 **6516** stars (+4376 today) | 🔤 JavaScript | 🏷️ core-stack
...
📊 **38** stars (+0 today) | 🔤 Python | 🏷️ core-stack, dev-tools, web3-defi, game-dev, frontend
...
📊 **24.605** stars (+3546 today) | 🔤 Python | 🏷️ core-stack
🔥 **RISING STAR** — 7 días trending
...
📊 **56.155** stars | 🔤 Python | 🏷️ core-stack, dev-tools, content-automation | 🔎 query: "tiktok automation ai"

### [freqtrade/freqtrade](https://github.com/freqtrade/freqtrade)
Free, open source crypto trading bot

📊 **49.167** stars | 🔤 Python | 🏷️ web3-defi | 🔎 query: "crypto trading bot open source"
...
📊 **20.343** stars | 🔤 JavaScript | 🏷️ core-stack, content-automation | 🔎 query: "claude code plugin"

### [hummingbot/hummingbot](https://github.com/hummingbot/hummingbot)
Open source software that helps you create and deploy high-frequency crypto trading bots

📊 **18.270** stars | 🔤 Python | 🏷️ web3-defi, infra | 🔎 query: "crypto trading bot open source"

### [anthropics/claude-plugins-official](https://github.com/anthropics/claude-plugins-official)
Official, Anthropic-managed directory of high quality Claude Code Plugins.

📊 **17.592** stars | 🔤 Python | 🏷️ core-stack | 🔎 query: "claude code plugin"

### [VoltAgent/awesome-agent-skills](https://github.com/VoltAgent/awesome-agent-skills)
A curated collection of 1000+ agent skills from official dev teams and the community, compatible with Claude Code, Codex, Gemini CLI, Cursor, and more.

📊 **17.441** stars | 🔤 Unknown | 🏷️ core-stack, dev-tools, web3-defi, game-dev | 🔎 query: "claude code agent skills"
...
📊 **5753** stars | 🔤 Python | 🏷️ web3-defi, frontend | 🔎 query: "crypto trading bot open source"
...
📊 **2944** stars | 🔤 Python | 🏷️ core-stack, web3-defi, game-dev, frontend | 🔎 query: "claude code game"
...
📊 **2283** stars | 🔤 C# | 🏷️ core-stack, dev-tools, web3-defi, game-dev, frontend | 🔎 query: "claude code unity"

### [timescale/pg-aiguide](https://github.com/timescale/pg-aiguide)
MCP server and Claude plugin for Postgres skills and documentation. Helps AI coding tools generate better PostgreSQL code.

📊 **1697** stars | 🔤 Python | 🏷️ core-stack, frontend, infra | 🔎 query: "claude code mcp server"
...
📊 **1687** stars | 🔤 TypeScript | 🏷️ core-stack, frontend | 🔎 query: "mcp server toolkit"
...
📊 **1648** stars | 🔤 Python | 🏷️ core-stack, web3-defi | 🔎 query: "claude code mcp server"
...
📊 **1435** stars | 🔤 JavaScript | 🏷️ core-stack | 🔎 query: "claude code mcp server"
...
- [langfuse/langfuse](https://github.com/langfuse/langfuse) — 🪢 Open source LLM engineering platform: LLM Observability, metrics, evals, prompt management, playg
...
- [cziberpv/unity-bridge](https://github.com/cziberpv/unity-bridge) — Let AI agents see and control Unity Editor through plain files. 25 commands, lens system, screenshot
- [jame581/GodotPrompter](https://github.com/jame581/GodotPrompter) — Agentic skills framework for Godot 4.x. Domain-specific skills for AI coding agents (Claude Code, Co
- [WebDecoy/FCaptcha](https://github.com/WebDecoy/FCaptcha) — Detect bots, vision AI agents, and headless browsers through 40+ behavioral signals and SHA-256 proo
- [AnkleBreaker-Studio/unity-mcp-plugin](https://github.com/AnkleBreaker-Studio/unity-mcp-plugin) — Unity MCP Plugin (UPM) — Editor bridge for AI-assisted game development. Enables Claude, Cursor & MC
