...
📊 **18.143** stars (+14.247 today) | 🔤 TypeScript | 🏷️ core-stack, web3-defi
...
📊 **31.196** stars (+9662 today) | 🔤 Python | 🏷️ core-stack
🔥 **RISING STAR** — 5 días trending
...
📊 **25.768** stars (+5240 today) | 🔤 Python | 🏷️ core-stack
🔥 **RISING STAR** — 3 días trending
...
📊 **24.382** stars (+1174 today) | 🔤 TypeScript | 🏷️ core-stack, dev-tools, frontend
...
📊 **31.325** stars (+0 today) | 🔤 Python | 🏷️ core-stack, dev-tools, web3-defi, game-dev
🔥 **RISING STAR** — 5 días trending
...
📊 **144.610** stars | 🔤 JavaScript | 🏷️ core-stack, dev-tools, web3-defi | 🔎 query: "claude code agent skills"

### [harry0703/MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.

📊 **55.213** stars | 🔤 Python | 🏷️ core-stack, dev-tools, content-automation | 🔎 query: "tiktok automation ai"
...
📊 **46.078** stars | 🔤 TypeScript | 🏷️ core-stack | 🔎 query: "claude code plugin"

### [hesreallyhim/awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
A curated list of awesome skills, hooks, slash-commands, agent orchestrators, applications, and plugins for Claude Code by Anthropic

📊 **37.210** stars | 🔤 Python | 🏷️ core-stack, dev-tools | 🔎 query: "claude code agent skills"

### [sickn33/antigravity-awesome-skills](https://github.com/sickn33/antigravity-awesome-skills)
Installable GitHub library of 1,370+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and more. Includes installer CLI, bundles, workflows, and official/community skill collections.

📊 **31.325** stars | 🔤 Python | 🏷️ core-stack, dev-tools, web3-defi, game-dev | 🔎 query: "claude code agent skills"

### [coreyhaines31/marketingskills](https://github.com/coreyhaines31/marketingskills)
Marketing skills for Claude Code and AI agents. CRO, copywriting, SEO, analytics, and growth engineering.

📊 **19.432** stars | 🔤 JavaScript | 🏷️ core-stack | 🔎 query: "claude code agent skills"
...
- [google-ai-edge/gallery](https://github.com/google-ai-edge/gallery) — ⭐ 18.664 — 3 días — general
- [google-ai-edge/LiteRT-LM](https://github.com/google-ai-edge/LiteRT-LM) — ⭐ 2468 — 3 días — general
- [Yeachan-Heo/oh-my-codex](https://github.com/Yeachan-Heo/oh-my-codex) — ⭐ 18.143 — 3 días — core-stack, web3-defi
- [siddharthvaddem/openscreen](https://github.com/siddharthvaddem/openscreen) — ⭐ 25.077 — 3 días — general
...
- [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) — ⭐ 31.196 — 5 días — core-stack
- [microsoft/VibeVoice](https://github.com/microsoft/VibeVoice) — ⭐ 37.269 — 5 días — general
- [onyx-dot-app/onyx](https://github.com/onyx-dot-app/onyx) — ⭐ 25.768 — 3 días — core-stack
...
- [siddharthvaddem/openscreen](https://github.com/siddharthvaddem/openscreen) — ⭐ 25.077 (+14.396) — TypeScript
- [microsoft/VibeVoice](https://github.com/microsoft/VibeVoice) — ⭐ 37.269 (+8392) — Python
- [sherlock-project/sherlock](https://github.com/sherlock-project/sherlock) — ⭐ 80.255 (+5811) — Python
- [google-research/timesfm](https://github.com/google-research/timesfm) — ⭐ 15.399 (+4241) — Python
- [google-ai-edge/gallery](https://github.com/google-ai-edge/gallery) — ⭐ 18.664 (+2008) — Kotlin
- [google-ai-edge/LiteRT-LM](https://github.com/google-ai-edge/LiteRT-LM) — ⭐ 2468 (+878) — C++
- [telegramdesktop/tdesktop](https://github.com/telegramdesktop/tdesktop) — ⭐ 31.251 (+866) — C++
- [NVIDIA/personaplex](https://github.com/NVIDIA/personaplex) — ⭐ 7854 (+663) — Python
- [nvim-treesitter/nvim-treesitter](https://github.com/nvim-treesitter/nvim-treesitter) — ⭐ 13.589 (+113) — Tree-sitter Query
- [forrestchang/andrej-karpathy-skills](https://github.com/forrestchang/andrej-karpathy-skills) — ⭐ 7959 (+42) — Unknown
...
---
*Generado por TECHINTEL v1.2 — OMEGA System — 2026-04-07T20:26:45.644Z*
