...
📊 **18.186** stars (+14.247 today) | 🔤 TypeScript | 🏷️ core-stack, web3-defi
🔥 **RISING STAR** — 3 días trending

### [luongnv89/claude-howto](https://github.com/luongnv89/claude-howto)
A visual, example-driven guide to Claude Code — from basic concepts to advanced agents, with copy-paste templates that bring immediate value.

📊 **22.333** stars (+12.085 today) | 🔤 Python | 🏷️ core-stack, frontend
🔥 **RISING STAR** — 5 días trending

### [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent)
The agent that grows with you

📊 **31.356** stars (+9662 today) | 🔤 Python | 🏷️ core-stack
🔥 **RISING STAR** — 5 días trending

### [Yeachan-Heo/oh-my-claudecode](https://github.com/Yeachan-Heo/oh-my-claudecode)
Teams-first Multi-agent orchestration for Claude Code

📊 **25.693** stars (+7832 today) | 🔤 TypeScript | 🏷️ core-stack
🔥 **RISING STAR** — 5 días trending
...
📊 **24.433** stars (+1174 today) | 🔤 TypeScript | 🏷️ core-stack, dev-tools, frontend
...
📊 **144.704** stars | 🔤 JavaScript | 🏷️ core-stack, dev-tools, web3-defi | 🔎 query: "claude code agent skills"
...
📊 **19.454** stars | 🔤 JavaScript | 🏷️ core-stack | 🔎 query: "claude code agent skills"
...
📊 **13.944** stars | 🔤 TypeScript | 🏷️ core-stack, frontend, infra | 🔎 query: "claude code plugin"
...
- [google-ai-edge/gallery](https://github.com/google-ai-edge/gallery) — ⭐ 18.712 — 3 días — general
- [google-ai-edge/LiteRT-LM](https://github.com/google-ai-edge/LiteRT-LM) — ⭐ 2504 — 3 días — general
- [Yeachan-Heo/oh-my-codex](https://github.com/Yeachan-Heo/oh-my-codex) — ⭐ 18.186 — 3 días — core-stack, web3-defi
- [siddharthvaddem/openscreen](https://github.com/siddharthvaddem/openscreen) — ⭐ 25.127 — 3 días — general
- [google-research/timesfm](https://github.com/google-research/timesfm) — ⭐ 15.420 — 3 días — general
- [luongnv89/claude-howto](https://github.com/luongnv89/claude-howto) — ⭐ 22.333 — 5 días — core-stack, frontend
- [Yeachan-Heo/oh-my-claudecode](https://github.com/Yeachan-Heo/oh-my-claudecode) — ⭐ 25.693 — 5 días — core-stack
- [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) — ⭐ 31.356 — 5 días — core-stack
...
- [siddharthvaddem/openscreen](https://github.com/siddharthvaddem/openscreen) — ⭐ 25.127 (+14.396) — TypeScript
- [microsoft/VibeVoice](https://github.com/microsoft/VibeVoice) — ⭐ 37.282 (+8392) — Python
- [sherlock-project/sherlock](https://github.com/sherlock-project/sherlock) — ⭐ 80.279 (+5811) — Python
- [google-research/timesfm](https://github.com/google-research/timesfm) — ⭐ 15.420 (+4241) — Python
- [google-ai-edge/gallery](https://github.com/google-ai-edge/gallery) — ⭐ 18.712 (+2008) — Kotlin
- [google-ai-edge/LiteRT-LM](https://github.com/google-ai-edge/LiteRT-LM) — ⭐ 2504 (+878) — C++
- [telegramdesktop/tdesktop](https://github.com/telegramdesktop/tdesktop) — ⭐ 31.255 (+866) — C++
...
---
*Generado por TECHINTEL v1.2 — OMEGA System — 2026-04-07T22:46:37.458Z*
