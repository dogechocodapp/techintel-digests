...
📊 **18.230** stars (+14.101 today) | 🔤 TypeScript | 🏷️ core-stack, web3-defi
🔥 **RISING STAR** — 4 días trending

### [luongnv89/claude-howto](https://github.com/luongnv89/claude-howto)
A visual, example-driven guide to Claude Code — from basic concepts to advanced agents, with copy-paste templates that bring immediate value.

📊 **22.379** stars (+10.745 today) | 🔤 Python | 🏷️ core-stack, frontend
🔥 **RISING STAR** — 5 días trending

### [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent)
The agent that grows with you

📊 **31.640** stars (+10.487 today) | 🔤 Python | 🏷️ core-stack
🔥 **RISING STAR** — 5 días trending

### [Yeachan-Heo/oh-my-claudecode](https://github.com/Yeachan-Heo/oh-my-claudecode)
Teams-first Multi-agent orchestration for Claude Code

📊 **25.717** stars (+7543 today) | 🔤 TypeScript | 🏷️ core-stack
🔥 **RISING STAR** — 5 días trending

### [onyx-dot-app/onyx](https://github.com/onyx-dot-app/onyx)
Open Source AI Platform - AI Chat with advanced features that works with every LLM

📊 **25.822** stars (+5449 today) | 🔤 Python | 🏷️ core-stack
🔥 **RISING STAR** — 4 días trending
...
📊 **24.490** stars (+1195 today) | 🔤 TypeScript | 🏷️ core-stack, dev-tools, frontend
...
📊 **144.782** stars | 🔤 JavaScript | 🏷️ core-stack, dev-tools, web3-defi | 🔎 query: "claude code agent skills"
...
📊 **46.126** stars | 🔤 TypeScript | 🏷️ core-stack | 🔎 query: "claude code plugin"

### [hesreallyhim/awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
A curated list of awesome skills, hooks, slash-commands, agent orchestrators, applications, and plugins for Claude Code by Anthropic

📊 **37.249** stars | 🔤 Python | 🏷️ core-stack, dev-tools | 🔎 query: "claude code agent skills"
...
- [google-ai-edge/gallery](https://github.com/google-ai-edge/gallery) — ⭐ 18.760 — 4 días — general
- [google-ai-edge/LiteRT-LM](https://github.com/google-ai-edge/LiteRT-LM) — ⭐ 2532 — 4 días — general
- [Yeachan-Heo/oh-my-codex](https://github.com/Yeachan-Heo/oh-my-codex) — ⭐ 18.230 — 4 días — core-stack, web3-defi
- [siddharthvaddem/openscreen](https://github.com/siddharthvaddem/openscreen) — ⭐ 25.172 — 4 días — general
- [google-research/timesfm](https://github.com/google-research/timesfm) — ⭐ 15.424 — 4 días — general
- [luongnv89/claude-howto](https://github.com/luongnv89/claude-howto) — ⭐ 22.379 — 5 días — core-stack, frontend
- [Yeachan-Heo/oh-my-claudecode](https://github.com/Yeachan-Heo/oh-my-claudecode) — ⭐ 25.717 — 5 días — core-stack
- [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) — ⭐ 31.640 — 5 días — core-stack
- [microsoft/VibeVoice](https://github.com/microsoft/VibeVoice) — ⭐ 37.308 — 5 días — general
- [onyx-dot-app/onyx](https://github.com/onyx-dot-app/onyx) — ⭐ 25.822 — 4 días — core-stack
...
- [siddharthvaddem/openscreen](https://github.com/siddharthvaddem/openscreen) — ⭐ 25.172 (+15.921) — TypeScript
- [sherlock-project/sherlock](https://github.com/sherlock-project/sherlock) — ⭐ 80.304 (+5167) — Python
...
- [google-ai-edge/gallery](https://github.com/google-ai-edge/gallery) — ⭐ 18.760 (+2934) — Kotlin
- [google-ai-edge/LiteRT-LM](https://github.com/google-ai-edge/LiteRT-LM) — ⭐ 2532 (+1336) — C++
- [telegramdesktop/tdesktop](https://github.com/telegramdesktop/tdesktop) — ⭐ 31.263 (+906) — C++
- [NVIDIA/personaplex](https://github.com/NVIDIA/personaplex) — ⭐ 7940 (+662) — Python
...
---
*Generado por TECHINTEL v1.2 — OMEGA System — 2026-04-08T00:44:57.848Z*
