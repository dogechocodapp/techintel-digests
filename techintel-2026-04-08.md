...
📊 **37.810** stars (+2543 today) | 🔤 Unknown | 🏷️ core-stack, dev-tools, web3-defi
🔥 **RISING STAR** — 4 días trending
...
📊 **24.485** stars (+1195 today) | 🔤 TypeScript | 🏷️ core-stack, dev-tools, frontend
...
📊 **144.775** stars | 🔤 JavaScript | 🏷️ core-stack, dev-tools, web3-defi | 🔎 query: "claude code agent skills"
...
📊 **46.123** stars | 🔤 TypeScript | 🏷️ core-stack | 🔎 query: "claude code plugin"

### [hesreallyhim/awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
A curated list of awesome skills, hooks, slash-commands, agent orchestrators, applications, and plugins for Claude Code by Anthropic

📊 **37.247** stars | 🔤 Python | 🏷️ core-stack, dev-tools | 🔎 query: "claude code agent skills"
...
📊 **19.470** stars | 🔤 JavaScript | 🏷️ core-stack | 🔎 query: "claude code agent skills"
...
📊 **17.506** stars | 🔤 JavaScript | 🏷️ core-stack, content-automation | 🔎 query: "claude code plugin"
...
- [google-ai-edge/gallery](https://github.com/google-ai-edge/gallery) — ⭐ 18.758 — 4 días — general
- [google-ai-edge/LiteRT-LM](https://github.com/google-ai-edge/LiteRT-LM) — ⭐ 2531 — 4 días — general
- [Yeachan-Heo/oh-my-codex](https://github.com/Yeachan-Heo/oh-my-codex) — ⭐ 18.228 — 4 días — core-stack, web3-defi
- [siddharthvaddem/openscreen](https://github.com/siddharthvaddem/openscreen) — ⭐ 25.170 — 4 días — general
- [google-research/timesfm](https://github.com/google-research/timesfm) — ⭐ 15.424 — 4 días — general
- [luongnv89/claude-howto](https://github.com/luongnv89/claude-howto) — ⭐ 22.378 — 5 días — core-stack, frontend
- [Yeachan-Heo/oh-my-claudecode](https://github.com/Yeachan-Heo/oh-my-claudecode) — ⭐ 25.715 — 5 días — core-stack
- [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) — ⭐ 31.628 — 5 días — core-stack
- [microsoft/VibeVoice](https://github.com/microsoft/VibeVoice) — ⭐ 37.308 — 5 días — general
...
- [siddharthvaddem/openscreen](https://github.com/siddharthvaddem/openscreen) — ⭐ 25.170 (+15.921) — TypeScript
- [sherlock-project/sherlock](https://github.com/sherlock-project/sherlock) — ⭐ 80.301 (+5167) — Python
- [microsoft/VibeVoice](https://github.com/microsoft/VibeVoice) — ⭐ 37.308 (+5025) — Python
- [google-research/timesfm](https://github.com/google-research/timesfm) — ⭐ 15.424 (+4137) — Python
- [google-ai-edge/gallery](https://github.com/google-ai-edge/gallery) — ⭐ 18.758 (+2934) — Kotlin
...
- [NVIDIA/personaplex](https://github.com/NVIDIA/personaplex) — ⭐ 7937 (+662) — Python
- [nvim-treesitter/nvim-treesitter](https://github.com/nvim-treesitter/nvim-treesitter) — ⭐ 13.595 (+159) — Tree-sitter Query
- [forrestchang/andrej-karpathy-skills](https://github.com/forrestchang/andrej-karpathy-skills) — ⭐ 8041 (+51) — Unknown
...
---
*Generado por TECHINTEL v1.2 — OMEGA System — 2026-04-08T00:40:17.659Z*
